...
class Archiver_nHentai {

	const LOG_TAG = 'Archiver_nHentai';
	...
	public function __construct() {
		$this->client = new Client_nHentai();
	...
	public function start() {
		...
		foreach($feeds as $feed) {
			...
			while(true) {
				...
				$indexPage = new nPage_Index($indexHtml);
	...
	protected function archiveGallery($gallery) {
		...
		$galleryPage = new nPage_Gallery($galleryHtml);
